...
{
float3 CH2 = float3(1.0, 0.98, 0.902);
float3 CH3 = float3(0.992, 0.961, 0.98);
float3 CH4 = float3(1.0, 1.0, 1.0);	

float3 Colne4no = float3(0.941, 0.941, 0.843);
float3 maloobla4no = float3(0.882, 0.784, 0.745);
float3 Yacnaya = float3(0.812, 0.792, 0.784);
float3 Oblachno = float3(0.941, 0.900, 0.845);

float4 wx = WeatherAndTime;
float3 cc;
float3 cn;
if (wx.x==0,1) cc = float3(0.941, 0.941, 0.843);
if (wx.y==0,1) cn = float3(0.941, 0.941, 0.843);

if (wx.x==2) cc = Yacnaya;
if (wx.x==3) cc = Oblachno;
if (wx.x==5) cc = Colne4no;
if (wx.x==6) cc = Yacnaya;
if (wx.x==10) cc = Yacnaya;
if (wx.x==11) cc = Colne4no;
...
if (wx.y==2) cn = Yacnaya;
if (wx.y==3) cn = Oblachno;
if (wx.y==5) cn = Colne4no;
if (wx.y==6) cn = Yacnaya;
if (wx.y==10) cn = Yacnaya;
if (wx.y==11) cn = Colne4no;
if (wx.y==13) cn = Colne4no;  
if (wx.y==14) cn = maloobla4no; 
if (wx.y==17) cn = Colne4no; 
if (wx.y==18) cn = maloobla4no; 

float3 wmix0 = lerp(cc, cn, wx.z);

float3 cc2;
float3 cn2;
if (wx.x==0,1) cc2 = float3(0.98, 0.953, 1.0);
if (wx.y==0,1) cn2 = float3(0.98, 0.953, 1.0);

if (wx.x==2) cc2 = float3(0.988, 1.0, 1.0);
if (wx.x==3) cc2 = float3(0.98, 0.958, 1.0);
if (wx.x==5) cc2 = float3(0.98, 0.953, 1.0);
if (wx.x==6) cc2 = float3(0.988, 1.0, 1.0);
if (wx.x==10) cc2 = float3(0.988, 1.0, 1.0);
if (wx.x==11) cc2 = float3(0.98, 0.953, 1.0);
if (wx.x==13) cc2 = float3(0.98, 0.953, 1.0);  
if (wx.x==14) cc2 = CH3; 
if (wx.x==17) cc2 = float3(0.98, 0.953, 1.0); 
if (wx.x==18) cc2 = CH3;


if (wx.y==2) cn2 = float3(0.988, 1.0, 1.0);
if (wx.y==3) cn2 = float3(0.98, 0.958, 1.0);
if (wx.y==5) cn2 = float3(0.98, 0.953, 1.0);
if (wx.y==6) cn2 = float3(0.988, 1.0, 1.0);
if (wx.y==10) cn2 = float3(0.988, 1.0, 1.0);
if (wx.y==11) cn2 = float3(0.98, 0.953, 1.0);
if (wx.y==13) cn2 = float3(0.98, 0.953, 1.0);  
if (wx.y==14) cn2 = CH3; 
if (wx.y==17) cn2 = float3(0.98, 0.953, 1.0); 
if (wx.y==18) cn2 = CH3; 

float3 wmix2 = lerp(cc2, cn2, wx.z);
   ...
   float df = pow(saturate(SunDirection.z * tf), 1.0);
	float3 sg = lerp(1.0, wmix0, pow(r0.y, 2.2));
	float3 sg2 = lerp(1.0, CH2, pow(r0.y, 1.15));
	float3 sd = lerp(1.0, wmix2, pow(r0.y, 2.15));
	float3 sd2 = lerp(1.0, CH4, pow(r0.y, 1.15));
...
float3 CT1 = float3(0.431, 0.471, 0.549);
float3 CT2 = float3(0.51, 0.745, 1.0);   

if (wx.x==0,1) cc =lerp(CT1, CT2, df);
if (wx.y==0,1) cn =lerp(CT1, CT2, df);

float3 skyW = float3(0.259, 0.259, 0.259);

float3 Colne4no = lerp(float3(0.431, 0.471, 0.549), float3(0.51, 0.745, 1), df);
float3 Colne4no2 = lerp(float3(0.431, 0.471, 0.549), float3(0.55, 0.745, 1.1), df);
float3 maloobla4no = lerp(float3(0.400, 0.471, 0.649), float3(0.45, 0.8, 1.0), df);
float3 Yacnaya = lerp(float3(0.480, 0.560, 0.610), float3(0.60, 0.85, 1.05), df);
float3 Yacnaya2 = lerp(float3(0.480, 0.560, 0.610), float3(0.60, 0.85, 1.25), df);
float3 Oblachno = lerp(float3(0.490, 0.550, 0.600), float3(0.65, 0.8, 0.9), df);
...
if (wx.y==2) cn = Yacnaya;
if (wx.y==3) cn = Oblachno;
if (wx.y==5) cn = Colne4no2;
if (wx.y==6) cn = Yacnaya;
if (wx.y==10) cn = Yacnaya2;
if (wx.y==11) cn = Colne4no2;
if (wx.y==13) cn = Colne4no;  
if (wx.y==14) cn = maloobla4no; 
if (wx.y==17) cn = Colne4no; 
if (wx.y==18) cn = maloobla4no; 
